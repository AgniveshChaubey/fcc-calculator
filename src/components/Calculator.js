    ...
    <>
      ...
      <div className="container mb-3" style={{ backgroundColor: 'black', maxWidth: '35em' }}>
        ...
        <div className="row p-2">
          <div id='clear' onClick={allClear} className="col col-6 col-md-6 border pt-3 pb-3">
            AC
          </div>
          <div id='divide' onClick={() => display('/')} className="col col-3 col-md-3 border pt-3 pb-3 operators">
            /
          </div>
          <div id='multiply' onClick={() => display('*')} className="col col-3 col-md-3 border pt-3 pb-3 operators">
            x
          </div>
          ...
          <div id='decimal' onClick={() => display('.')} className="col col-3 col-md-3 border pt-3 pb-3">
            .
          </div>
